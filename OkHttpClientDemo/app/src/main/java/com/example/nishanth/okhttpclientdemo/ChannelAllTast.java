...
public class ChannelAllTast extends AsyncTask<String,Void,ArrayList<Channels>> {

        SubscriptionActivity activity;
        ChannelAllTast(SubscriptionActivity activity){
        ...
        protected ArrayList<Channels> doInBackground(String... params) {
            try {
                ...
                ArrayList<Channels> channelses = ParseQuestionsJson.parseJsonChannelsALL(response.body().string());
                return channelses;
            } catch (IOException e) {
                e.printStackTrace();
            }
        ...
        protected void onPostExecute(ArrayList<Channels> channelsArrayList) {
            ...
            activity.printSubChannelALLData(channelsArrayList);

        }

        public  interface SubChannelALLData{
            void printSubChannelALLData(ArrayList<Channels> channelsArrayList);
        }
