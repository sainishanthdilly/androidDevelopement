...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>,
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()) {
                                ...
                                Log.w("sign in task", "signInWithEmail:failed", task.getException());
    ...
    private void updateUI(FirebaseUser user) {
        ...
        String last_name = user.getDisplayName();

        User_Table user_table = new User_Table(user.getUid(),email1,first_name,last_name,String.valueOf(user.getPhotoUrl()), f,f,f);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Log.d("signInWithCred", "signInWithCredential:success");
                            FirebaseUser user = mAuth.getCurrentUser();
                            updateUI(user);
                        } else {
                            // If sign in fails, display a message to the user.
                            Log.w("Good", "signInWithCredential:failure", task.getException());
