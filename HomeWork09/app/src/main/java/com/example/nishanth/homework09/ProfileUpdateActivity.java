...
public class ProfileUpdateActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            try {
                ...
                imageBitmap = getRoundedRectBitmap(imageBitmap,100);
    ...
    public void updateProfile(MenuItem item){
        Intent i = new Intent(ProfileUpdateActivity.this,ProfileUpdateActivity.class);
        startActivity(i);
    ...
    public void logout(MenuItem item){
        ...
        Intent i = new Intent(ProfileUpdateActivity.this,LoginActivity.class);
        startActivity(i);
    }
